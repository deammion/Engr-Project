...
The diagram below shows the logical interactions of the proxy. It shows how each stage: collection, analyse, and operational all act independently from each other, and how they function relative to the end user, depending on what stage the proxy is set too. <br>
