...
|                               | Availability Consistent (99.99%) uptime is necessary for the product to be viable. Any downtime should be planned - not system failures. Downtime for customers is not acceptable as business-critical or sensitive operations could be interrupted. | High (See Redshield:  Owner - Stability/Reliability)                                                                                                                                                                                                                                              | High (See  Redshield:  Owner - Stability/Reliability)                                                                                                                                                                                                                                 | Low (See  Redshield:  Owner - Stability/Reliability)                                                                                                                                                                                                 | Maintainability (See  Redshield:  Owner - Stability/Reliability)                                                                                                                                       |
